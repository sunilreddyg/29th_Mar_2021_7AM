...
public class Verify_Dropdown_Multiple_Options 
{

	public static void main(String[] args) throws Exception 
	{
		/*
		 * How to verify dropdown is allowed morethan one option..
		 */
		...
		if(flag==true)
		{
			...
			Thread.sleep(2000);
				...
				{
					System.out.println("Dropdown Allowed more than one option to select");
				}
				else
				{
