...
public class Extent_Reports_Using_ScreenShot {
	...
	public static void main(String[] args) throws Exception 
	{
		...
		WebDriver driver;
		String driver_path="new_driver_path\\chromedriver.exe";
		...
		System.out.println("Reporter file created");
			...
			ExtentTest test1=logger.startTest("Tc001_loginvalid");
				...
				String screen1_path="C:\\Users\\SUNIL\\git\\29th_Mar_2021_7AM\\Project_189\\screens\\Screen1.png";
				File src=((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
				FileHandler.copy(src, new File(screen1_path));
				
				//Attach screen to extent report file.
				test1.log(LogStatus.PASS, "ScreenCaptured",test1.addScreenCapture(screen1_path));
